...
import numpy as np
import torch
from data.datasets.hdf5_lightning_proposal import HDF5_Dataset, ChainedHDF5_Dataset
from data.sampler.object_sampler import DistributedObjectSampler

class LociProposalDataModule(LightningDataModule):
    def __init__(self, cfg: Configuration):
        ...
        self.trainset = ChainedHDF5_Dataset(
            [HDF5_Dataset(
                ...
                seed=cfg.seed, 
                max_num_mask_per_image=cfg.model.num_slots
